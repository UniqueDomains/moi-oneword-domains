# Available .MOI One-Word Domains (5,622,489)

<p align="left">
  <img alt="status" src="https://img.shields.io/badge/status-active-2ea44f">
  <img alt="updated" src="https://img.shields.io/badge/updated-daily-0969da">
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-5%2C217%20rows-8250df">
  <img alt="live catalog" src="https://img.shields.io/badge/live%20catalog-5%2C622%2C489%20domains-6f42c1">
...
> **Important:** this repository is a **public 5,217-row extract**, not the full live catalog.
> The full live catalog for this exact search currently contains **5,622,489 domains** on the canonical page below.

**Public extract:** 5,217 rows · **Live catalog:** 5,622,489 domains
...
<p align="center">
  ...
  <a href="https://unique.domains/domains/tld/moi?github_intent=radar&utm_source=github&utm_medium=referral&utm_campaign=repo_moi_oneword_domains&utm_content=top_create_radar"><b>🔔 Create Radar</b></a> ·
  <a href="https://unique.domains/domains/tld/moi?github_intent=project&utm_source=github&utm_medium=referral&utm_campaign=repo_moi_oneword_domains&utm_content=top_start_project"><b>🚀 Start a Project</b></a> ·
  <b>⬇️ Download sample</b>: <a href="./moi.csv">CSV</a> / <a href="./moi.json">JSON</a>
</p>

<p align="center">
  <a href="https://unique.domains/technology?utm_source=github&utm_medium=referral&utm_campaign=repo_moi_oneword_domains&utm_content=top_methodology">Methodology</a> ·
  <a href="https://unique.domains/api?utm_source=github&utm_medium=referral&utm_campaign=repo_moi_oneword_domains&utm_content=top_api_docs">API docs</a>
</p>
...
- **Investors:** [Create a Radar from this exact .MOI search](https://unique.domains/domains/tld/moi?github_intent=radar&utm_source=github&utm_medium=referral&utm_campaign=repo_moi_oneword_domains&utm_content=top_create_radar)
- **Founders:** [Start a Project from this exact .MOI search](https://unique.domains/domains/tld/moi?github_intent=project&utm_source=github&utm_medium=referral&utm_campaign=repo_moi_oneword_domains&utm_content=top_start_project)
- **Researchers / builders:** [Download CSV](./moi.csv) or [Download JSON](./moi.json)
...
| ----------------------- | ------------------------------------------------ |
| 5,217-row public sample | 5,622,489 live domains                           |
...
| ------------- | --------- | --------- | ------------- | -------------- | ------ | ------ | --------- |
| chase.moi     | available | $39.99    | —             | 66             | 87     | 5      | name.com  |
| morgan.moi    | premium   | $250      | —             | 74             | 83     | 6      | name.com  |
...
| hello.moi     | premium   | $1,250    | —             | 92             | 71     | 5      | name.com  |
...
| march.moi     | available | $39.99    | —             | 70             | 82     | 5      | name.com  |
...
> Unique Domains. *Available .MOI One-Word Domains*. Version 2026-04-09. Public GitHub extract for the exact Unique Domains search represented by this repository.
